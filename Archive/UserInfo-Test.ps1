...
write-host "      ADPS Menu - User Information" -ForegroundColor darkcyan
write-host "========================================" -ForegroundColor darkcyan
write-host "      $startdate"`n -ForegroundColor darkcyan
write-host "Selected Function: [1] User Functions - User Information"`n -foregroundcolor darkcyan
write-host "[i] To go back, type 'exit'"`n -foregroundcolor darkcyan
Write-Host "Selected User: $dispname ($uname)"`n -foregroundcolor darkcyan



# Displaying the info using the above variables
Write-Host "Name: " -ForegroundColor Yellow -NoNewline; write-host "$UIName"
Write-Host "Username: " -ForegroundColor Yellow -NoNewline; write-host "$UIUsername"
...
if ($UIEnabled -eq 'true'){write-host "Status: " -ForegroundColor Yellow -NoNewline; write-host "Enabled" -ForegroundColor Green -NoNewline; write-host " | " -NoNewline}
else{write-host "Status: " -ForegroundColor Yellow -NoNewline; write-host "Disabled" -ForegroundColor red -NoNewline; write-host " | " -NoNewline}
