...
if ($Stripe -notcontains $uname -and $null -ne $StripeAccess){Write-Host "WARN - NOT IN GROUP" -ForegroundColor Red; Start-Sleep 1; Write-Host "WARN - NOT IN GROUP" -ForegroundColor Yellow; Start-Sleep1; Write-Host "WARN - NOT IN GROUP" -ForegroundColor Red; Start-Sleep1; write-host " | Access Level: $StripeAccess" -ForegroundColor Yellow}
